...
function App() {
  const [tasks, setTasks] = useState([
    { id: Date.now(1), title: 'Task1', completed: false },
    { id: Date.now(2), title: 'Task2', completed: false },
    { id: Date.now(3), title: 'Task3', completed: false },
    { id: Date.now(4), title: 'Task4', completed: false },
  ]);
